...
const items = [
  { slot:1, name:"No Boundaries Blue", price:590, mrp:590, size:"3XL", color:"Blue", category:"Shirt", photo:"https://kwbbkvfudrzznrhoumej.supabase.co/storage/v1/object/public/product-media/8995a7bd-2850-4a9f-9a13-7c4b1f41ffe6/regen-thumb-1777823630-20.png" },
  { slot:2, name:"Oakley Green XXL", price:620, mrp:620, size:"XXL", color:"Green", category:"Shirt", photo:"https://kwbbkvfudrzznrhoumej.supabase.co/storage/v1/object/public/product-media/8995a7bd-2850-4a9f-9a13-7c4b1f41ffe6/regen-thumb-1777823630-24.png" },
  { slot:3, name:"SuperDry Trousers", price:490, mrp:490, size:"42", color:"Orange", category:"Trouser", photo:"https://kwbbkvfudrzznrhoumej.supabase.co/storage/v1/object/public/product-media/8995a7bd-2850-4a9f-9a13-7c4b1f41ffe6/regen-thumb-1777823630-9.png" },
];
...
for (const it of items) {
  ...
  writeFileSync(`/tmp/banner-${it.slot}.svg`, svg);
  console.log("wrote", it.slot, svg.length);
}
